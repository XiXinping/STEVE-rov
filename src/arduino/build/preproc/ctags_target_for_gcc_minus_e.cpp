# 1 "/home/pi/STEVE-rov/src/arduino/arduino.ino"
# 2 "/home/pi/STEVE-rov/src/arduino/arduino.ino" 2
# 3 "/home/pi/STEVE-rov/src/arduino/arduino.ino" 2
# 4 "/home/pi/STEVE-rov/src/arduino/arduino.ino" 2
# 5 "/home/pi/STEVE-rov/src/arduino/arduino.ino" 2
# 6 "/home/pi/STEVE-rov/src/arduino/arduino.ino" 2
# 7 "/home/pi/STEVE-rov/src/arduino/arduino.ino" 2
# 8 "/home/pi/STEVE-rov/src/arduino/arduino.ino" 2
...
void drive_motors(int8_t x_velocity, int8_t y_velocity, int8_t z_velocity,
    ...
    for (uint8_t i = 0; i < 6; i++) {
        ...
        if (((motor_velocities[i])>0?(motor_velocities[i]):-(motor_velocities[i])) > speed_limits[i]) {
        ...
        if (((motor_velocities[i])>0?(motor_velocities[i]):-(motor_velocities[i])) < 32) {
            speed_limits[i] = 32;
        }
        if (((motor_velocities[i])>0?(motor_velocities[i]):-(motor_velocities[i])) > 64) {
            speed_mins[i] = 64;
        }
    ...
    for (uint8_t i = 0; i < 6; i++) {
        ...
        if (((motor_velocities[i])>0?(motor_velocities[i]):-(motor_velocities[i])) < 16) {
