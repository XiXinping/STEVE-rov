# 1 "/home/pi/underwater-rov/src/motors/other_motor_test/other_motor_test.ino"
/*************************************************** 
 ...
 ****************************************************/
# 20 "/home/pi/underwater-rov/src/motors/other_motor_test/other_motor_test.ino"
# 21 "/home/pi/underwater-rov/src/motors/other_motor_test/other_motor_test.ino" 2
# 22 "/home/pi/underwater-rov/src/motors/other_motor_test/other_motor_test.ino" 2
...
void setup() {
   ...
   */
# 71 "/home/pi/underwater-rov/src/motors/other_motor_test/other_motor_test.ino"
...
void loop() {
  ...
  for (uint16_t pulselen = 150 /* This is the 'minimum' pulse length count (out of 4096)*/; pulselen < 600 /* This is the 'maximum' pulse length count (out of 4096)*/; pulselen++) {
    pwm.setPWM(servonum, 0, pulselen);
  }

  delay(500);
  for (uint16_t pulselen = 600 /* This is the 'maximum' pulse length count (out of 4096)*/; pulselen > 150 /* This is the 'minimum' pulse length count (out of 4096)*/; pulselen--) {
    pwm.setPWM(servonum, 0, pulselen);
  }
